...
const routes: Routes = [
  ...
  { path: 'generate-pdf', loadComponent: () => import('../../modules/application/manarega/approval-process-manarega/generate-pdf/generate-pdf.component').then(m => m.GeneratePdfComponent), data: { breadcrumb: [{ title: 'Generate Pdf', active: true }] }, canActivate: [] },
