...
export class InventoryComponent {
  ...
  setTableData() {
    ...
    let displayedheaders = this.lang == 'en' ? ['Sr. No.', 'Grainage', 'Type', 'State', 'Lot No', 'Race', 'Purchase Qty(DFLs)', 'In Stock'] :
      ['अनुक्रमांक', 'धान्य', 'प्रकार', 'राज्य', 'लॉट नंबर', 'जात', 'खरेदीची संख्या(DFLs)', 'स्टॉक मध्ये'];
    let tableData = {
