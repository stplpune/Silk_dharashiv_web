...
const routes: Routes = [
  ...
  { path: 'track-application', loadChildren: () => import('../../modules/track-application/track-application.module').then(m => m.TrackApplicationModule), data: { breadcrumb: [{ title: 'Track Application', active: true }] } },
