...
const routes: Routes = [
  ...
  { path: 'create-samgra-app', loadChildren: () => import('../../modules/application/samgra/create-samgra-app/create-samgra-app.module').then(m => m.CreateSamgraAppModule), data: { breadcrumb: [{ title: 'Create Samgra App', active: true }] }, canActivate: [ExpenseGuard] },
