...
const routes: Routes = [
  ...
  { path: 'technical-estimate', loadComponent: () => import('../../modules/application/manarega/approval-process-manarega/technical-estimate/technical-estimate.component').then(m => m.TechnicalEstimateComponent) , data: { breadcrumb: [{ title: 'Technical Estimate', active: true }] } },
