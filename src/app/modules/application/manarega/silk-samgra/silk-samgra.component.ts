...
import { GeoTaggingComponent } from '../approval-process/geo-tagging/geo-tagging.component';
import { WebStorageService } from 'src/app/core/services/web-storage.service';

@Component({
  selector: 'app-silk-samgra',
  templateUrl: './silk-samgra.component.html',
  styleUrls: ['./silk-samgra.component.scss']
})
export class SilkSamgraComponent implements OnDestroy {
