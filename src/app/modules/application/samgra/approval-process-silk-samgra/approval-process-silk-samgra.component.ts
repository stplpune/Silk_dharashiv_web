...
@Component({
  selector: 'app-approval-process-silk-samgra',
  templateUrl: './approval-process-silk-samgra.component.html',
  styleUrls: ['./approval-process-silk-samgra.component.scss']
})
export class ApprovalProcessSilkSamgraComponent {
